...
DEFAULT_CONFIG = {
    ...
    "announcement_message": "برای اجاره بات به آیدی @123.002 پیام دهید!"
}
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "6996bb9200130f631a9f0ef7")
    api_token = os.getenv("API_TOKEN", "82cbb79fe285627be0f433c5307180fe72077afadd4c06dc6c9bf75447ac5b21")
